...
public class HR_MergeTwoSortedLists 
{
    ...
    // Using Iteration
    // Video Link: https://www.youtube.com/watch?v=j_UNYW6Ap0k
    static SinglyLinkedListNode mergeLists(SinglyLinkedListNode head1, SinglyLinkedListNode head2)
    {
        ...
        // Creating new node to refer head3
        ...
        // In case two list are not of same size
        if(head1 == null) current_node.next = head2;
        else current_node.next = head1;
